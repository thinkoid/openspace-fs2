...
# by radar-check. The ART half re-entered service 2026-07-31: world.gd
# instances this Control as its radar gauge and feeds blips from the
# boundary's snapshot -- presentation only, the projection spec below
# unchanged.
#
