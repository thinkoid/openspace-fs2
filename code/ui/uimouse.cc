...
ui_mouse_process()
{
    ...
    if ((ui_mouse.b1_status & BUTTON_PRESSED) &&
        ...
        if (timer_get_milliseconds() <=
            ui_mouse.b1_time_lastpressed + 250) //&& (ui_mouse.moved==0)
    ...
    else if ((ui_mouse.b1_status & BUTTON_RELEASED) &&
    ...
    if ((ui_mouse.b2_status & BUTTON_PRESSED) &&
        ...
        if (timer_get_milliseconds() <=
            ui_mouse.b2_time_lastpressed + 250) //&& (ui_mouse.moved==0)
    ...
    else if ((ui_mouse.b2_status & BUTTON_RELEASED) &&
