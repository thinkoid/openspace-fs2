...
typedef struct physics_info
{
    ...
    matrix
        I_body_inv; // inverse moment of inertia tensor (used to calculate rotational effects)
    ...
    vector
        afterburner_max_vel; // maximum foward velocity in x,y,z while afterburner engaged
...
extern void physics_read_flying_controls(matrix *orient, physics_info *pi,
                                         control_info *ci, float sim_time,
...
extern void physics_apply_whack(vector *force, vector *pos, physics_info *pi,
                                matrix *orient, float mass);
extern void physics_apply_shock(vector *direction_vec, float pressure,
                                physics_info *pi, matrix *orient, vector *min,
                                vector *max, float radius);
extern void physics_collide_whack(vector *impulse, vector *delta_rotvel,
...
void physics_predict_pos(physics_info *pi, float delta_time,
                         vector *predicted_pos);
void physics_predict_vel(physics_info *pi, float delta_time,
                         vector *predicted_vel);
void physics_predict_pos_and_vel(physics_info *pi, float delta_time,
