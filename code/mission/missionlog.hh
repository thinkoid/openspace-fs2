...
// of the event.
extern void mission_log_add_entry(int type, char *pname, char *sname,
                                  int index = -1);
...
// happened
extern int mission_log_get_time_indexed(int type, char *name, char *sname,
                                        int count, fix *time);
...
void mission_log_scrollback(int scroll_offset, int list_x, int list_y, int list_w,
                            int list_h);
