...
extern int
    Ship_select_open; // This game-wide global flag is set to 1 to indicate that the ship
...
void ss_apply(int mode, int from_slot, int from_index, int to_slot, int to_index,
              int player_index = -1);
