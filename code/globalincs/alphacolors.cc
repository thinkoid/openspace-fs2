...
color Color_red, Color_bright_red, Color_yellow, Color_bright_yellow,
    Color_dim_red;
color Color_ui_light_green, Color_ui_green;
color Color_ui_light_pink, Color_ui_pink;

// netplayer colors
color *Color_netplayer[12] = { &Color_white,        &Color_bright_white,
                               &Color_bright_blue,  &Color_red,
                               &Color_bright_red,   &Color_blue,
                               &Color_bright_green, &Color_bright_blue,
                               &Color_yellow,       &Color_bright_yellow,
                               &Color_ui_green,     &Color_ui_pink };
