...
static void gr_opengl_aabitmap_ex_internal(int x,int y,int w,int h,int sx,int sy)
{
	...
	ubyte fc_alpha = gr_screen.current_color.is_alphacolor ? gr_screen.current_color.alpha : 255;
	glColor4ub(gr_screen.current_color.red, gr_screen.current_color.green, gr_screen.current_color.blue, fc_alpha);
...
static void gr_opengl_bitmap_internal(int x,int y,int w,int h,int sx,int sy)
{
	unsigned int tex=0;
	bitmap * bmp;
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, wtemp, htemp, 0, GL_BGRA, GL_UNSIGNED_SHORT_1_5_5_5_REV, NULL);
...
void gr_opengl_init()
{
	...
	Gr_red.bits = 5;	Gr_red.shift = 11;	Gr_red.scale = 8;	Gr_red.mask = 0xF800;
	Gr_green.bits = 6;	Gr_green.shift = 5;	Gr_green.scale = 4;	Gr_green.mask = 0x7E0;
	Gr_blue.bits = 5;	Gr_blue.shift = 0;	Gr_blue.scale = 8;	Gr_blue.mask = 0x1F;

	Gr_t_red.bits = 5;	Gr_t_red.shift = 10;	Gr_t_red.scale = 8;	Gr_t_red.mask = 0x7C00;
	Gr_t_green.bits = 5;	Gr_t_green.shift = 5;	Gr_t_green.scale = 8;	Gr_t_green.mask = 0x03e0;
	Gr_t_blue.bits = 5;	Gr_t_blue.shift = 0;	Gr_t_blue.scale = 8;	Gr_t_blue.mask = 0x001f;
	Gr_t_alpha.bits = 1;	Gr_t_alpha.shift = 15;	Gr_t_alpha.scale = 255;	Gr_t_alpha.mask = 0x8000;

	Gr_ta_red.bits = 4;	Gr_ta_red.shift = 8;	Gr_ta_red.scale = 17;	Gr_ta_red.mask = 0x0f00;
	Gr_ta_green.bits = 4;	Gr_ta_green.shift = 4;	Gr_ta_green.scale = 17;	Gr_ta_green.mask = 0x00f0;
	Gr_ta_blue.bits = 4;	Gr_ta_blue.shift = 0;	Gr_ta_blue.scale = 17;	Gr_ta_blue.mask = 0x000f;
	Gr_ta_alpha.bits = 4;	Gr_ta_alpha.shift = 12;	Gr_ta_alpha.scale = 17;	Gr_ta_alpha.mask = 0xf000;
