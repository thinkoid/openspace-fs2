...
void model_get_dock_name(int, int)
{
	oracle_trap("model_get_dock_name");
}

void model_get(int)
{
	oracle_trap("model_get");
}

void model_get_num_dock_points(int)
{
	oracle_trap("model_get_num_dock_points");
}
