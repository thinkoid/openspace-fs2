...
static void oracle_trap2(const char *sym)
{
...
{
	oracle_trap2("find_freespace_cd");
}

void game_check_key()
{
	oracle_trap2("game_check_key");
}

void game_do_cd_mission_check(char*)
{
	oracle_trap2("game_do_cd_mission_check");
}

void game_do_state_common(int, int)
{
	oracle_trap2("game_do_state_common");
}

void game_do_state(int)
{
	oracle_trap2("game_do_state");
}

void game_enter_state(int, int)
{
	oracle_trap2("game_enter_state");
}

void game_flash(float, float, float)
{
	oracle_trap2("game_flash");
}

void game_flush()
{
	oracle_trap2("game_flush");
}

void game_format_time(long, char*)
{
	oracle_trap2("game_format_time");
}

void game_get_default_skill_level()
{
	oracle_trap2("game_get_default_skill_level");
}

void game_increase_skill_level()
{
	oracle_trap2("game_increase_skill_level");
}

void game_leave_state(int, int)
{
	oracle_trap2("game_leave_state");
}

void game_poll()
{
	oracle_trap2("game_poll");
}

void game_process_event(int, int)
{
	oracle_trap2("game_process_event");
}

void game_set_frametime(int)
{
	oracle_trap2("game_set_frametime");
}

void game_set_view_clip()
{
	oracle_trap2("game_set_view_clip");
}

void game_shudder_apply(int, float)
{
	oracle_trap2("game_shudder_apply");
}
...
{
	oracle_trap2("game_tst_mark");
}

void game_whack_apply(float, float)
{
	oracle_trap2("game_whack_apply");
}

void get_version_string(char*)
{
	oracle_trap2("get_version_string");
}

void set_cdrom_path(int)
{
	oracle_trap2("set_cdrom_path");
}
