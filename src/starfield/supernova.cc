...
void
supernova_apply_shake(matrix *eye_orient, float intensity)
{
    angles tangles;
...
void
supernova_set_view(vector *eye_pos, matrix *eye_orient)
{
    vector at;
    vector sun_temp, sun;
    vector move;
    ...
    vm_vec_scale_add(&Supernova_camera_pos, &Player_obj->pos, &whee.rvec,
                     sn_cam_distance);
    ...
    *eye_pos = Supernova_camera_pos;
    ...
    // otherwise move it
        ...
        float pct = ((SUPERNOVA_CUT_TIME - Supernova_time) /
