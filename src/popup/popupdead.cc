...
UI_BUTTON Popupdead_button_regions
    [POPUPDEAD_NUM_CHOICES_MAX]; // fake buttons used for mouse detection over text

int Popupdead_region_coords[GR_NUM_RESOLUTIONS][POPUPDEAD_NUM_CHOICES_MAX][4] = {
    {
        // GR_640
        { 464, 389, 497,
          403 }, // upper right pixel of text, lower right pixel of button (for tiny popup)
        { 464, 413, 497, 427 },
        { 464, 435, 497, 446 },
        { 464, 457, 497, 466 },
    },
    {
        ...
        { 745, 627, 809, 664 },
        { 745, 663, 809,
          700 }, // upper right pixel of text, lower right pixel of button (for tiny popup)
        { 745, 699, 809, 736 },
        { 745, 735, 809, 772 },
    },
};
...
popupdead_start()
{
    ...
    Popupdead_window.create(Popupdead_background_coords[gr_screen.res][0],
                            Popupdead_background_coords[gr_screen.res][1], 1, 1,
                            0);
...
popupdead_restart()
{
    ...
    Popupdead_active = 0;
    Player
        ->failures_this_session--; // hacky correction for a double count when calling popupdead_start() twice
    popupdead_start();
}

// do the "skip mission" version of the death popup
int
popupdead_skip_do_frame()
{
    ...
    gr_string(0x8000, Popupdead_skip_message_y[gr_screen.res],
              XSTR("You have failed this mission five times.", 1470));
    gr_string(0x8000,
              Popupdead_skip_message_y[gr_screen.res] + gr_get_font_height(),
              XSTR("If you like, you may advance to the next mission.", 1471));
...
int
popupdead_do_frame(float frametime)
{
    int k, choice;
