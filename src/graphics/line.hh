...
#define INT_CLIPLINE(x1, y1, x2, y2, XMIN, YMIN, XMAX, YMAX, WHEN_OUTSIDE,       \
                     WHEN_CLIPPED, WHEN_SWAPPED)                                 \
    do {                                                                         \
        int temp;                                                                \
                                                                                 \
        if (y1 > y2) {                                                           \
...
#define FL_CLIPLINE(x1, y1, x2, y2, XMIN, YMIN, XMAX, YMAX, WHEN_OUTSIDE,        \
                    WHEN_CLIPPED, WHEN_SWAPPED)                                  \
    do {                                                                         \
        float temp;                                                              \
                                                                                 \
