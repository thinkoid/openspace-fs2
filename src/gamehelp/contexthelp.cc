...
static int current_helpid =
    -1; // the currently active overlay_id, only really used for the debug console funxions
...
int
help_overlay_active(int overlay_id)
{
...
void
help_overlay_set_state(int overlay_id, int state)
{
    Assert(overlay_id >= 0 && overlay_id < MAX_HELP_OVERLAYS);
...
void
help_overlay_load(int overlay_id)
{
    return;
}
...
// FIXME - leftover from the old bitmap overlay days - prune this out sometime
void
help_overlay_unload(int overlay_id)
{
    return;
}
...
void
help_overlay_maybe_blit(int overlay_id)
{
    Assert(overlay_id >= 0 && overlay_id < MAX_HELP_OVERLAYS);
        ...
        while (!(check_for_string("$end"))) {
            if (optional_string("+pline")) {
                ...
                if (currcount < HELP_MAX_ITEM) {
                    ...
                    for (i = 0; i < help_overlaylist[overlay_id]
                                        .plinelist[GR_640][currcount]
                                        .vtxcount;
                         i++) {
                        stuff_int(&a);
                        ...
                        help_overlaylist[overlay_id]
                            .plinelist[GR_640][currcount]
                            .pvtx[i] = &help_overlaylist[overlay_id]
                                            .plinelist[GR_640][currcount]
                                            .vtx[i];
                    }
                ...
                if (currcount < HELP_MAX_ITEM) {
                    ...
                    // get 1024x768 coordinates
                    stuff_int(&(help_overlaylist[overlay_id]
                                    .rbracketlist[GR_1024][currcount]
                                    .x_coord));
                    stuff_int(&(help_overlaylist[overlay_id]
                                    .rbracketlist[GR_1024][currcount]
                                    .y_coord));
                ...
                if (currcount < HELP_MAX_ITEM) {
                    ...
                    // get 1024x768 coordinates
                    stuff_int(&(help_overlaylist[overlay_id]
                                    .lbracketlist[GR_1024][currcount]
                                    .x_coord));
                    stuff_int(&(help_overlaylist[overlay_id]
                                    .lbracketlist[GR_1024][currcount]
                                    .y_coord));
...
void
help_overlay_blit(int overlay_id)
{
    ...
    for (idx = 0; idx < textcount; idx++) {
        ...
        gr_rect(
            help_overlaylist[overlay_id].textlist[gr_screen.res][idx].x_coord -
                2 * HELP_PADDING,
    ...
    for (idx = 0; idx < rbracketcount; idx++) {
        ...
        gr_bitmap(
            help_overlaylist[overlay_id].rbracketlist[gr_screen.res][idx].x_coord,
    ...
    for (idx = 0; idx < lbracketcount; idx++) {
        ...
        gr_bitmap(
            help_overlaylist[overlay_id].lbracketlist[gr_screen.res][idx].x_coord,
    ...
    for (idx = 0; idx < plinecount; idx++) {
        gr_pline_special(
            help_overlaylist[overlay_id].plinelist[gr_screen.res][idx].pvtx,
            help_overlaylist[overlay_id].plinelist[GR_640][idx].vtxcount,
            HELP_PLINE_THICKNESS);
    }
}
...
void
nudgetext_x(int textnum, int amount)
{
    help_overlaylist[current_helpid].textlist[gr_screen.res][textnum].x_coord +=
        amount;
}
void
nudgetext_y(int textnum, int amount)
{
    help_overlaylist[current_helpid].textlist[gr_screen.res][textnum].y_coord +=
        amount;
}
void
nudgepline_x(int plinenum, int plinevert, int amount)
{
    help_overlaylist[current_helpid]
        .plinelist[gr_screen.res][plinenum]
        .vtx[plinevert]
        .x += amount;
}
void
nudgepline_y(int plinenum, int plinevert, int amount)
{
    help_overlaylist[current_helpid]
        .plinelist[gr_screen.res][plinenum]
        .vtx[plinevert]
...
void
nudgerbracket_x(int num, int amount)
{
    help_overlaylist[current_helpid].rbracketlist[gr_screen.res][num].x_coord +=
        amount;
}
void
nudgerbracket_y(int num, int amount)
{
    help_overlaylist[current_helpid].rbracketlist[gr_screen.res][num].y_coord +=
        amount;
}
void
nudgelbracket_x(int num, int amount)
{
    help_overlaylist[current_helpid].lbracketlist[gr_screen.res][num].x_coord +=
        amount;
}
void
nudgelbracket_y(int num, int amount)
{
    help_overlaylist[current_helpid].lbracketlist[gr_screen.res][num].y_coord +=
        amount;
}
void
showtextpos(int textnum)
{
    dc_printf(
...
void
showplinepos(int plinenum)
{
    int i;
    dc_printf("pline %d on overlay %d vertices are now ", plinenum,
              current_helpid,
              help_overlaylist[current_helpid]
                  .textlist[gr_screen.res][plinenum]
                  .y_coord);
    for (i = 0;
         i <
         help_overlaylist[current_helpid].plinelist[GR_640][plinenum].vtxcount;
         i++) {
        dc_printf("(%3.0f %3.0f) ",
                  help_overlaylist[current_helpid]
                      .plinelist[gr_screen.res][plinenum]
