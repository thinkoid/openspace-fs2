...
int mission_ai_goal_achievable(
    ai_goals *aigp); // determines if an AI goal is achievable
void
mission_add_ai_goal(int sexp,
                    ai_info *aip); // adds a goal onto the given ai_info structure
...
void mission_goal_fetch_num_resolved(int desired_type, int *num_resolved,
                                     int *total, int team = -1);
...
void
ML_render_objectives_key(); // renders objectives key on ingame objectives screen
