...
void light_add_directional(vector *dir, float intensity, float r, float g,
                           float b);
void light_add_point(vector *pos, float r1, float r2, float intensity, float r,
                     float g, float b, int ignore_objnum);
void light_add_point_unique(vector *pos, float r1, float r2, float intensity,
                            float r, float g, float b, int affected_objnum);
void light_add_tube(vector *p0, vector *p1, float r1, float r2, float intensity,
                    float r, float g, float b, int affected_objnum);
...
void light_apply_rgb(ubyte *param_r, ubyte *param_g, ubyte *param_b, vector *pos,
                     vector *norm, float static_light_val);
