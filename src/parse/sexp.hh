...
// if we ever have more than 1024 (!) total sexps, we're going to have to figure
// out a different way of distinguishing between sexp identifier and sexp array
// index
#define FIRST_OP 0x0400

// IMPORTANT: because of the way categories work, no category can have more than
// 256 sexps (mapped to 00 through ff) otherwise they'll overlap their category)
...
#define OP_CATEGORY_GOAL_EVENT  0x0f00 // final category can't be higher than 0x0f00 to avoid overlap with flags above
#define OP_CATEGORY_MASK        0x0f00 // 0000111100000000b

// The debug category is obsolete, so I removed it.  It originally took the
// place of OP_CATEGORY_CONDITIONAL, which was bumped (along with all the lower
// categories) so that FIRST_OP could be 0x0400.  This allows for 1024 possible
// sexps, as opposed to the 768 possible if the categories had not been bumped.
