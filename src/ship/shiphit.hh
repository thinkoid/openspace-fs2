...
extern void do_subobj_destroyed_stuff(ship *ship_p, ship_subsys *subsys,
                                      vector *hitpos);
...
void ship_apply_local_damage(object *ship_obj, object *other_obj, vector *hitpos,
                             float damage, int shield_quadrant,
                             bool create_spark = true, int submodel_num = -1,
...
void ship_hit_kill(object *ship_obj, object *other_obj, float percent_killed,
                   int self_destruct);
