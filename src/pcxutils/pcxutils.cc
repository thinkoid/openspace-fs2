...
int
pcx_read_header(char *real_filename, int *w, int *h, ubyte *pal)
{
    PCXHeader header;
    CFILE *PCXfile;
...
int
pcx_read_bitmap_16bpp(char *real_filename, ubyte *org_data)
{
    PCXHeader header;
    CFILE *PCXfile;
    int row, col, count, xsize, ysize;
...
int
pcx_read_bitmap_16bpp_aabitmap(char *real_filename, ubyte *org_data)
{
    PCXHeader header;
    CFILE *PCXfile;
    int row, col, count, xsize, ysize;
...
int
pcx_read_bitmap_16bpp_nondark(char *real_filename, ubyte *org_data)
{
    PCXHeader header;
    CFILE *PCXfile;
    int row, col, count, xsize, ysize;
...
int
pcx_encode_byte(ubyte byt, ubyte cnt, FILE *fid)
{
    if (cnt) {
...
int
pcx_encode_line(ubyte *inBuff, int inLen, FILE *fp)
{
    ubyte this_ptr, last;
...
int
pcx_write_bitmap(char *real_filename, int w, int h, ubyte **row_ptrs,
                 ubyte *palette)
{
    int retval;
    int i;
...
char pcx_error_messages[] = { "No error.\0"
