...
#include <io/sw_guid.hh>
#include <vdinput.h>
#include <io/sw_error.hh>
...
HRESULT SWFF_OpenDefaultFFJoystick(IN HWND hWnd, OUT LPDIRECTINPUT *ppDI,
                                   OUT LPDIRECTINPUTDEVICE2 *ppDIDevice2);

HRESULT SWFF_OpenDefaultFFJoystickEx(IN HWND hWnd, IN HINSTANCE hInstance,
...
HRESULT SWFF_SetDirectionGain(IN LPDIRECTINPUTEFFECT pDIEffect, IN DWORD dwAngle,
                              IN DWORD dwMag);

HRESULT SWFF_PutRawForce(IN LPDIRECTINPUTEFFECT pDIEffect, IN LONG lMagnitude,
...
HRESULT SWFF_CreateRawForceEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                  ...
                                  IN LONG lMagnitude, IN DWORD dwDirection);

HRESULT SWFF_CreateRawAxisForceEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                      IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                      IN LONG lMagnitude, IN DWORD dwAxis);

HRESULT SWFF_CreateROMEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                             IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                             IN REFGUID refGUID, IN DWORD dwDuration,
                             IN DWORD dwGain, IN DWORD dwDirection,
                             IN LONG lButton);

HRESULT SWFF_CreatePeriodicEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                  IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                  IN DWORD dwType, IN DWORD dwDuration,
                                  IN DWORD dwPeriod, IN DWORD dwDirection,
                                  IN DWORD dwMagnitude, IN LONG lOffset,
                                  IN DWORD dwAttackTime, IN DWORD dwAttackLevel,
                                  IN DWORD dwFadeTime, IN DWORD dwFadeLevel,
                                  IN LONG lButton);

HRESULT SWFF_CreateSpringEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                IN DWORD dwDuration, IN LONG lKx,
                                IN LONG lCenterX, IN LONG lKy, IN LONG lCenterY,
                                IN LONG lButton);

HRESULT SWFF_CreateDamperEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                IN DWORD dwDuration, IN LONG lBx, IN LONG lV0x,
                                IN LONG lBy, IN LONG lV0y, IN LONG lButton);

HRESULT SWFF_CreateInertiaEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                 IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                 IN DWORD dwDuration, IN LONG lMx, IN LONG lA0x,
                                 IN LONG lMy, IN LONG lA0y, IN LONG lButton);

HRESULT SWFF_CreateFrictionEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                  IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                  IN DWORD dwDuration, IN LONG lFx, IN LONG lFy,
                                  IN LONG lButton);

HRESULT SWFF_CreateConditionEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                   IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                   IN DWORD dwType, IN DWORD dwDuration,
                                   IN LONG lXCoefficient, IN LONG lXOffset,
                                   IN LONG lYCoefficient, IN LONG lYOffset,
                                   IN LONG lButton);

HRESULT SWFF_CreateRampEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                              IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                              IN DWORD dwDuration, IN DWORD dwDirection,
                              IN LONG lStart, IN LONG lEnd, IN DWORD dwAttackTime,
                              IN DWORD dwAttackLevel, IN DWORD dwFadeTime,
                              IN DWORD dwFadeLevel, IN LONG lButtonMask);

HRESULT SWFF_CreateConstantForceEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                       IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                       IN DWORD dwDuration, IN DWORD dwDirection,
                                       IN LONG lMagnitude, IN DWORD dwAttackTime,
...
HRESULT SWFF_CreateWallEffect(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                              IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                              IN DWORD dwDuration, IN DWORD dwDirection,
                              IN DWORD dwDistance, IN BOOL bInner,
                              IN LONG lWallCoefficient, IN LONG lButton);
...
HRESULT SWFF_CreateVFXEffectFromFileEx(IN LPDIRECTINPUTDEVICE2 pDIDevice,
                                       IN OUT LPDIRECTINPUTEFFECT *ppDIEffect,
                                       IN const TCHAR *pszFileName,
                                       IN DWORD dwDuration, IN DWORD dwGain,
                                       IN DWORD dwDirection);
...
HRESULT SWFF_CreateDIEffectFromBufferEx(
    IN LPDIRECTINPUTDEVICE2 pDIDevice, IN OUT LPDIRECTINPUTEFFECT **pppDIEffect,
    IN OUT PDWORD pdwEffectCount, IN const LPVOID pBuffer, IN DWORD dwBufferSize,
    IN OUT void **ppUDBuffer, IN OUT PDWORD pdwOutFlags);
...
DECLARE_INTERFACE_(IVFX, IUnknown)
{
    ...
    // General Methods
    STDMETHOD_(HRESULT, CreateEffectFromFile)(THIS_ LPDIRECTINPUTDEVICE2,
                                              LPDIRECTINPUTEFFECT *, LPDWORD,
                                              const TCHAR *, LPVOID, LPDWORD,
                                              DWORD, LPDWORD) PURE;

    STDMETHOD_(HRESULT, CreateEffectFromBuffer)(THIS_ LPDIRECTINPUTDEVICE2,
                                                LPDIRECTINPUTEFFECT *, LPDWORD,
                                                PVOID, DWORD, LPVOID, LPDWORD,
                                                DWORD, LPDWORD) PURE;
};
