...
// meaning, always make the string empty
#define EG_NULL -1
// title bar of the weapon gauge
#define EG_WEAPON_TITLE 0
// first primary weapon slot
#define EG_WEAPON_P1 1
// second primary weapon slot
#define EG_WEAPON_P2 2
// third primary weapon slot
#define EG_WEAPON_P3 3
// first secondary weapon slot
#define EG_WEAPON_S1 4
// second secondary weapon slot
#define EG_WEAPON_S2 5
// first item on escort list
#define EG_ESCORT1 6
// second item on escort list
#define EG_ESCORT2 7
// third item on escort list
#define EG_ESCORT3 8
// titlebar of the directives gauge
#define EG_OBJ_TITLE 9
// line 1 of the directives display
#define EG_OBJ1 10
// line 2
#define EG_OBJ2 11
// line 3
...
// line 5
#define EG_OBJ5 14
// extra target info line 1
#define EG_TBOX_EXTRA1 15
// extra target info line 2
#define EG_TBOX_EXTRA2 16
// extra target info line 3
...
void emp_apply(vector *pos, float inner_radius, float outer_radius,
