...
#define GS_EVENT_START_GAME                                                      \
    1 // start a new game (Loads a mission then goes to briefing state)
#define GS_EVENT_ENTER_GAME                                                      \
    2 // switches into game state, probably after mission briefing or ship selection.
#define GS_EVENT_START_GAME_QUICK                                                \
    3 // start a new game (Loads a mission then goes to directly to game state)
...
#define GS_EVENT_CONTROL_CONFIG                                                  \
    19 // get user to choose what type of controller to config
...
#define GS_EVENT_TRAINING_PAUSE                                                  \
    39 // pause game while training message is displayed
#define GS_EVENT_PLAYER_WARPOUT_START 41 // player hit 'j' to warp out
#define GS_EVENT_PLAYER_WARPOUT_START_FORCED                                     \
    42 // player is being forced out of mission no matter what
#define GS_EVENT_PLAYER_WARPOUT_STOP                                             \
    43 // player hit 'esc' or something to cancel warp out
#define GS_EVENT_PLAYER_WARPOUT_DONE_STAGE1 44 // player ship got up to speed
#define GS_EVENT_PLAYER_WARPOUT_DONE_STAGE2                                      \
    45 // player ship got through the warp effect
#define GS_EVENT_PLAYER_WARPOUT_DONE 46 // warp effect went away
#define GS_EVENT_INITIAL_PLAYER_SELECT                                           \
    48 // initial screen where player selects from multi/single player pilots
...
#define GS_STATE_TRAINING_PAUSED                                                 \
    34 // game is paused while training msg is being read.
...
#define GS_STATE_END_OF_CAMPAIGN                                                 \
    46 // end of main campaign -- only applicable in single player
