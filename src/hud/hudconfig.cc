...
int HUD_config_default_flags2 = { (1 << (HUD_OFFSCREEN_RANGE - 32)) |
...
struct HC_gauge_region HC_gauge_regions[GR_NUM_RESOLUTIONS][NUM_HUD_GAUGES] = {
    {
        ...
        HC_gauge_region("HCB_36", 305, 119, 36, 1, 0, -1, 0,
                        2), // orientation tee
        HC_gauge_region("none", 1, 1, -1, 1, 0, -1, 0, 0), // hostile triangle
        HC_gauge_region("HCB_37", 391, 107, 37, 1, 0, -1, 0,
                        2), // target triangle
        ...
        HC_gauge_region("HCB_41", 361, 188, 41, 0, 0, -1, 0,
                        0), // center of reticle
        HC_gauge_region("HCB_30", 123, 221, 30, 0, 0, -1, 0,
                        0), // extra target data
        HC_gauge_region("HCB_49", 237, 303, 49, 0, 0, -1, 0,
                        0), // target shield icon
        HC_gauge_region("HCB_51", 435, 304, 51, 0, 0, -1, 0,
                        0), // player shield icon
        ...
        HC_gauge_region("HCB_29", 123, 142, 29, 0, 0, -1, 0,
                        0), // directives view
        HC_gauge_region("HCB_43", 398, 147, 43, 0, 0, -1, 0, 0), // threat gauge
        HC_gauge_region("HCB_39", 250, 212, 39, 0, 0, -1, 0,
                        0), // afterburner energy
        HC_gauge_region("HCB_44", 449, 212, 44, 0, 0, -1, 0, 0), // weapons energy
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0, 0), // weapon linking
        HC_gauge_region("HCB_42", 356, 232, 42, 0, 1, -1, 0,
                        0), // target mini icon (shield)
        HC_gauge_region("HCB_34", 438, 5, 34, 1, 0, -1, 0,
                        2), // offscreen indicator
        ...
        HC_gauge_region("HCB_45", 307, 249, 45, 1, 0, -1, 0,
                        1), // missile warnings
        HC_gauge_region("HCB_56", 505, 271, 56, 0, 1, -1, 0, 0), // cmeasure gauge
        HC_gauge_region("HCB_33", 309, 87, 33, 0, 0, -1, 0,
                        0), // objectives notify gauge
        HC_gauge_region("HCB_53", 546, 117, 53, 0, 0, -1, 0,
                        0), // wingman status gauge
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0,
                        0), // offscreen indicator range
        HC_gauge_region("HCB_57", 505, 285, 57, 0, 1, -1, 0, 0), // kills gauge
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0,
                        0), // attacking target count
        HC_gauge_region("HCB_38", 342, 138, 38, 0, 0, -1, 0,
                        0), // text flash gauge
        HC_gauge_region("HCB_52", 465, 8, 52, 0, 0, -1, 0, 0), // comm menu
        HC_gauge_region("HCB_46", 324, 264, 46, 0, 0, -1, 0,
                        0), // support view gauge
        HC_gauge_region("HCB_47", 418, 262, 47, 0, 0, -1, 0,
                        0), // netlag icon gauge
        //XSTR:ON
    },
    {
        // GR_1024
        //XSTR:OFF
        HC_gauge_region("2_HCB_35", 652, 112, 35, 1, 0, -1, 0,
                        2), // lead indicator
        HC_gauge_region("2_HCB_36", 489, 191, 36, 1, 0, -1, 0,
                        2), // orientation tee
        HC_gauge_region("none", 1, 1, -1, 1, 0, -1, 0, 0), // hostile triangle
        HC_gauge_region("2_HCB_37", 626, 173, 37, 1, 0, -1, 0,
                        2), // target triangle
        HC_gauge_region("2_HCB_63", 920, 564, 63, 0, 0, -1, 0, 0), // mission time
        HC_gauge_region("none", 1, 1, 1, 0, 0, -1, 0, 0), // reticle circle?
        HC_gauge_region("2_HCB_40", 456, 235, 40, 0, 0, -1, 0,
                        0), // throttle gauge
        HC_gauge_region("2_HCB_50", 508, 466, 50, 0, 0, -1, 0, 0), // radar
        HC_gauge_region("2_HCB_31", 198, 399, 31, 0, 0, -1, 0,
                        0), // target monitor
        HC_gauge_region("2_HCB_41", 578, 302, 41, 0, 0, -1, 0,
                        0), // center of reticle
        HC_gauge_region("2_HCB_30", 198, 354, 30, 0, 0, -1, 0,
                        0), // extra target data
        HC_gauge_region("2_HCB_49", 380, 485, 49, 0, 0, -1, 0,
                        0), // target shield icon
        HC_gauge_region("2_HCB_51", 696, 486, 51, 0, 0, -1, 0,
                        0), // player shield icon
        ...
        HC_gauge_region("2_HCB_55", 807, 346, 55, 0, 1, -1, 0,
                        0), // weapons gauge
        HC_gauge_region("2_HCB_54", 794, 265, 54, 0, 1, -1, 0, 0), // escort view
        HC_gauge_region("2_HCB_29", 198, 228, 29, 0, 0, -1, 0,
                        0), // directives view
        HC_gauge_region("2_HCB_43", 637, 237, 43, 0, 0, -1, 0, 0), // threat gauge
        HC_gauge_region("2_HCB_39", 403, 339, 39, 0, 0, -1, 0,
                        0), // afterburner energy
        HC_gauge_region("2_HCB_44", 719, 339, 44, 0, 0, -1, 0,
                        0), // weapons energy
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0, 0), // weapon linking
        HC_gauge_region("2_HCB_42", 569, 371, 42, 0, 1, -1, 0,
                        0), // target mini icon (shield)
        HC_gauge_region("2_HCB_34", 701, 9, 34, 1, 0, -1, 0,
                        2), // offscreen indicator
        ...
        HC_gauge_region("2_HCB_45", 491, 399, 45, 1, 0, -1, 0,
                        1), // missile warnings
        HC_gauge_region("2_HCB_56", 808, 433, 56, 0, 1, -1, 0,
                        0), // cmeasure gauge
        HC_gauge_region("2_HCB_33", 495, 141, 33, 0, 0, -1, 0,
                        0), // objectives notify gauge
        HC_gauge_region("2_HCB_53", 873, 188, 53, 0, 0, -1, 0,
                        0), // wingman status gauge
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0,
                        0), // offscreen indicator range
        ...
        HC_gauge_region("none", 1, 1, -1, 0, 0, -1, 0,
                        0), // attacking target count
        HC_gauge_region("2_HCB_38", 548, 222, 38, 0, 0, -1, 0,
                        0), // text flash gauge
        HC_gauge_region("2_HCB_52", 744, 14, 52, 0, 0, -1, 0, 0), // comm menu
        HC_gauge_region("2_HCB_46", 520, 422, 46, 0, 0, -1, 0,
                        0), // support view gauge
        HC_gauge_region("2_HCB_47", 670, 419, 47, 0, 0, -1, 0,
                        0), // netlag icon gauge
        //XSTR:ON
    }
};
...
static HUD_CONFIG_TYPE
    HUD_config_backup; // backup HUD config, used to restore old config if changes not applied
...
// sync sliders
void
hud_config_synch_sliders(int i)
{
    if (i >= 0) {
...
hud_config_init_ui()
{
    ...
    HC_fname_input.create(&HC_ui_window, HC_fname_coords[gr_screen.res][0],
...
int
hud_config_show_flag_is_set(int i)
{
    int show_flag_set;
...
void
hud_config_show_flag_set(int i)
{
    if (i < 32) {
...
void
hud_config_show_flag_clear(int i)
{
    if (i < 32) {
        HUD_config.show_flags &= ~(1 << i);
    }
...
int
hud_config_popup_flag_is_set(int i)
{
    int popup_flag_set;
...
void
hud_config_popup_flag_set(int i)
{
    if (i < 32) {
...
void
hud_config_popup_flag_clear(int i)
{
    if (i < 32) {
        HUD_config.popup_flags &= ~(1 << i);
    }
...
hud_config_render_gauges()
{
    ...
    for (i = 0; i < NUM_HUD_GAUGES; i++) {
        ...
        if (HC_gauge_regions[gr_screen.res][i].bitmap >= 0) {
            ...
            gr_aabitmap(HC_gauge_regions[gr_screen.res][i].x,
                        HC_gauge_regions[gr_screen.res][i].y);
        }
...
void
hud_config_set_gauge_flags(int gauge_index, int on_flag, int popup_flag)
{
    if (on_flag) {
...
void
hud_config_record_color(int color)
{
...
// Set the HUD color
void
hud_config_set_color(int color)
{
    int idx;
    ...
    for (idx = 0; idx < NUM_HUD_GAUGES; idx++) {
        gr_init_alphacolor(&HUD_config.clr[idx], HC_colors[color].r,
                           HC_colors[color].g, HC_colors[color].b,
                           (HUD_color_alpha + 1) * 16);
    }
}

void
hud_config_stuff_colors(int r, int g, int b)
{
    int idx;
...
void
hud_config_handle_keypresses(int k)
{
    switch (k) {
    case KEY_ESC:
        hud_config_cancel();
...
hud_config_button_do(int n)
{
    ...
    case HCB_SAVE_HCF:
        ...
        if (HC_num_files >= MAX_HCF_FILES) {
            popup(PF_USE_AFFIRMATIVE_ICON, 1, "OK",
...
void
hud_config_button_disable(int index)
{
...
void
hud_config_button_enable(int index)
{
...
hud_config_render_description()
{
    ...
    if (HC_gauge_selected >= 0) {
        ...
        sx = fl2i(HC_gauge_description_coords[gr_screen.res][0] +
...
//
void
hud_config_do_frame(float frametime)
{
    int k;
...
void
hud_set_default_hud_config(player *p)
{
    int idx;
...
void
hud_config_color_save(char *name)
{
    int idx;
...
hud_config_alpha_slider_up()
{
    ...
    int mx = max(max(HCS_CONV(HC_color_sliders[HCS_RED].get_currentItem()),
...
{
    int pos = HCS_CONV(HC_color_sliders[HCS_ALPHA].get_currentItem());
    int mn = min(min(HCS_CONV(HC_color_sliders[HCS_RED].get_currentItem()),
                     HCS_CONV(HC_color_sliders[HCS_GREEN].get_currentItem())),
                 HCS_CONV(HC_color_sliders[HCS_BLUE].get_currentItem()));
...
hud_config_red_slider()
{
    ...
    if (HC_select_all) {
        for (idx = 0; idx < NUM_HUD_GAUGES; idx++) {
            gr_init_alphacolor(&HUD_config.clr[idx], pos,
                               HUD_config.clr[idx].green,
                               HUD_config.clr[idx].blue,
                               HUD_config.clr[idx].alpha);
        }
    }
    // individual gauge
        ...
        // get slider position
        gr_init_alphacolor(&HUD_config.clr[HC_gauge_selected], pos,
...
hud_config_green_slider()
{
    ...
    if (HC_select_all) {
        for (idx = 0; idx < NUM_HUD_GAUGES; idx++) {
            gr_init_alphacolor(&HUD_config.clr[idx], HUD_config.clr[idx].red, pos,
                               HUD_config.clr[idx].blue,
                               HUD_config.clr[idx].alpha);
        }
    }
    // individual gauge
        ...
        // get slider position
        gr_init_alphacolor(&HUD_config.clr[HC_gauge_selected],
...
hud_config_blue_slider()
{
    ...
    if (HC_select_all) {
        for (idx = 0; idx < NUM_HUD_GAUGES; idx++) {
            gr_init_alphacolor(&HUD_config.clr[idx], HUD_config.clr[idx].red,
                               HUD_config.clr[idx].green, pos,
                               HUD_config.clr[idx].alpha);
        }
    }
    // individual gauge
...
hud_config_color_init()
{
    ...
    HC_num_files = cf_get_file_list(MAX_HCF_FILES, HC_filenames, CF_TYPE_PLAYERS,
                                    "*.hcf", CF_SORT_NAME);
}
...
void
hud_config_select_all_toggle(int toggle)
{
    int r, g, b, a;
