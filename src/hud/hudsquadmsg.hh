...
#define SUPPORT_MESSAGES                                                         \
    (REARM_REPAIR_ME_ITEM | ABORT_REARM_REPAIR_ITEM | STAY_NEAR_ME_ITEM |        \
     STAY_NEAR_TARGET_ITEM | KEEP_SAFE_DIST_ITEM | DEPART_ITEM)
...
extern void hud_squadmsg_save_keys(
    int do_scroll =
        0); // saves into local area keys which need to be saved/restored when in messaging mode
