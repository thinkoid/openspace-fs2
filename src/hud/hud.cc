...
color HUD_color_defaults
    [HUD_NUM_COLOR_LEVELS]; // array of colors with different alpha blending
...
static int
    Hud_can_target_timer; // timestamp to allow target gauge to draw static once targeting functions are not allowed

// centered text message gauges (collision, emp, etc)
char Hud_text_flash[512] = "";
int Hud_text_flash_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                       -1, 172 },
                                                     { // GR_1024
                                                       -1, 275 } };
...
int Red_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                 -1, 116 },
                                               { // GR_1024
                                                 -1, 186 } };
int Red_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                     -1, 124 },
                                                   { // GR_1024
                                                     -1, 194 } };

// subspace popup
int Subspace_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                      -1, 116 },
                                                    { // GR_1024
                                                      -1, 186 } };
int Subspace_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                          100, 124 },
                                                        { // GR_1024
                                                          140, 194 } };

// message text coords
int Head_message_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                     7, 37 },
                                                   { // GR_1024
                                                     11, 57 } };
...
int Kills_gauge_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                    497, 361 },
                                                  { // GR_1024
                                                    880, 624 } };
int Kills_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                   503, 365 },
                                                 { // GR_1024
                                                   886, 628 } };

#if defined(GERMAN_BUILD)
int Kills_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                       615, 365 },
                                                     { // GR_1024
                                                       984, 628 } };
#else
...
char Kills_fname[GR_NUM_RESOLUTIONS][MAX_FILENAME_LEN] = { "kills1", "kills1" };

// used to draw border around a talking head
static hud_frames Head_frame_gauge;
static int Head_frame_gauge_loaded = 0;
int Head_frame_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                   5, 35 },
                                                 { // GR_1024
                                                   5, 56 } };
char Head_fname[GR_NUM_RESOLUTIONS][MAX_FILENAME_LEN] = { "head1", "head1" };

// mission time frame
static hud_frames Mission_time_gauge;
static int Mission_time_gauge_loaded = 0;
int Mission_time_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                     587, 448 },
                                                   { // GR_1024
                                                     969, 716 } };
int Mission_time_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                          591, 452 },
                                                        { // GR_1024
                                                          973, 720 } };
int Mission_time_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                              613, 460 },
                                                            { // GR_640
                                                              995, 728 } };
char Mission_time_fname[GR_NUM_RESOLUTIONS][MAX_FILENAME_LEN] = { "time1",
                                                                  "time1" };
...
int Support_view_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                     265, 334 },
                                                   { // GR_1024
                                                     459, 534 } };
int Support_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                     267, 335 },
                                                   { // GR_1024
                                                     462, 536 } };
int Support_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                         -1, 348 },
                                                       { // GR_1024
                                                         -1, 546 } };
...
int Support_text_dock_val_coords[GR_NUM_RESOLUTIONS]
                                [2] = { // time value for "dock in" x coord
                                    { // GR_640
                                      328, -1 },
                                    { // GR_1024
                                      524, -1 }
                                };
char Support_fname[GR_NUM_RESOLUTIONS][MAX_FILENAME_LEN] = { "support1",
                                                             "support1" };
...
int Damage_gauge_line_h[GR_NUM_RESOLUTIONS] = { 9, 9 };
...
int Damage_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                    248, 40 },
                                                  { // GR_1024
                                                    443, 63 } };
int Hull_integ_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                   249, 53 },
                                                 { // GR_1024
                                                   444, 76 } };
...
int Damage_subsys_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                           249, 65 },
                                                         { // GR_1024
                                                           444, 88 } };
...
int Objective_display_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                          245, 114 },
                                                        { // GR_1024
                                                          436, 184 } };
int Objective_text_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                       -1, 116 },
                                                     { // GR_1024
                                                       -1, 186 } };
int Objective_text_val_coords[GR_NUM_RESOLUTIONS][2] = { { // GR_640
                                                           -1, 125 },
                                                         { // GR_1024
                                                           -1, 195 } };
char Objective_fname[GR_NUM_RESOLUTIONS][MAX_FILENAME_LEN] = { "objective1",
                                                               "objective1" };
...
HUD_init_hud_color_array()
{
    ...
    for (i = 0; i < HUD_NUM_COLOR_LEVELS; i++) {
        gr_init_alphacolor(&HUD_color_defaults[i], HUD_color_red, HUD_color_green,
...
hud_init_talking_head_gauge()
{
    ...
    if (!Head_frame_gauge_loaded) {
        Head_frame_gauge.first_frame = bm_load_animation(
            Head_fname[gr_screen.res], &Head_frame_gauge.num_frames);
        if (Head_frame_gauge.first_frame == -1) {
            Warning(LOCATION,
                    "Could not load in ani: Head_fname[gr_screen.res]\n");
        }
...
hud_init_mission_time_gauge()
{
    ...
    if (!Mission_time_gauge_loaded) {
        Mission_time_gauge.first_frame = bm_load_animation(
            Mission_time_fname[gr_screen.res], &Mission_time_gauge.num_frames);
        if (Mission_time_gauge.first_frame == -1) {
            Warning(LOCATION,
                    "Could not load in ani: Mission_time_fname[gr_screen.res]\n");
        }
...
HUD_init()
{
    ...
    hud_anim_init(&Target_static, Target_window_coords[gr_screen.res][0],
                  Target_window_coords[gr_screen.res][1], NOX("TargetStatic"));
        ...
        for (i = 0; i < swp->num_secondary_banks; i++) {
            if (swp->secondary_bank_ammo[i] > 0) {
                int ms_till_fire = timestamp_until(
                    swp->next_secondary_fire_stamp[i]);
...
hud_update_frame()
{
    ...
    if ((!retarget) && (Player_ai->target_objnum != -1)) {
        if (Objects[Player_ai->target_objnum].type == OBJ_SHIP) {
            if (!(Ships[Objects[Player_ai->target_objnum].instance].flags &
                  SF_DYING)) {
    ...
    if (targetp->type == OBJ_SHIP && Event_Music_battle_started == 0) {
        ...
        if (opposing_team_mask(Player_ship->team)) {
            ...
            if (dist_to_target < BATTLE_START_MIN_TARGET_DIST) {
                ...
                if (stricmp(
                        Ai_class_names[Ai_info[target_shipp->ai_index].ai_class],
                        NOX("none")))
    ...
    if (target_shipp) {
        float initial_hull;
        initial_hull =
            Ship_info[target_shipp->ship_info_index].initial_hull_strength;
        if (initial_hull <= 0) {
...
void
HUD_render_forward_icon(object *objp)
{
    vertex v0;
    vector p0;
    ...
    if ((!(v0.flags & PF_OVERFLOW)) &&
        (v0.codes == 0)) // make sure point projected
...
void
hud_show_common_3d_gauges(float frametime, int in_cockpit)
{
    ...
    if (!(Viewer_mode & (VM_EXTERNAL | VM_SLEWED | VM_CHASE | VM_DEAD_VIEW |
        ...
        if (hud_gauge_active(HUD_MISSILE_WARNING_ARROW)) {
            hud_show_homing_missiles();
             ...
             (VM_CHASE | VM_EXTERNAL | VM_WARP_CHASE | VM_PADLOCK_ANY)) {
...
hud_maybe_show_damage()
{
    ...
    if (hud_gauge_active(HUD_DAMAGE_GAUGE)) {
        ...
        if ((Ship_info[Player_ship->ship_info_index].initial_hull_strength -
             Player_obj->hull_strength) > 1.0f) {
            show_gauge_flag = 1;
        }
        else {
            show_gauge_flag = 0;
...
hud_damage_popup_toggle()
{
    ...
    if (hud_gauge_is_popup(HUD_DAMAGE_GAUGE)) {
        if (Player_obj->hull_strength ==
            Ship_info[Player_ship->ship_info_index].initial_hull_strength) {
            hud_config_set_gauge_flags(HUD_DAMAGE_GAUGE, 1, 0);
        }
        else {
...
hud_show_mission_time()
{
    ...
    if (Mission_time_gauge.first_frame >= 0) {
        GR_AABITMAP(Mission_time_gauge.first_frame,
                    Mission_time_coords[gr_screen.res][0],
                    Mission_time_coords[gr_screen.res][1]);
    }

    // print out mission time in MM:SS format
    gr_printf(Mission_time_text_coords[gr_screen.res][0],
              Mission_time_text_coords[gr_screen.res][1], NOX("%02d:%02d"),
              minutes, seconds);

    // display time compression as xN
    time_comp = f2fl(Game_time_compression);
    if (time_comp < 1) {
        gr_printf(Mission_time_text_val_coords[gr_screen.res][0],
                  Mission_time_text_val_coords[gr_screen.res][1],
                  XSTR("x%.1f", 215), time_comp);
    }
    else {
        gr_printf(Mission_time_text_val_coords[gr_screen.res][0],
                  Mission_time_text_val_coords[gr_screen.res][1],
                  XSTR("x%.0f", 216), time_comp);
    }
}
...
hud_maybe_blit_head_border()
{
    ...
    if (message_anim_is_playing()) {
        ...
        GR_AABITMAP(Head_frame_gauge.first_frame,
                    Head_frame_coords[gr_screen.res][0],
                    Head_frame_coords[gr_screen.res][1]);

        // draw title
        gr_string(Head_message_coords[gr_screen.res][0],
                  Head_message_coords[gr_screen.res][1], XSTR("message", 217));
    }
}
...
hud_maybe_clear_head_area()
{
    ...
    if (message_anim_is_playing()) {
        ...
        if (gr_screen.res == GR_640) {
            HUD_set_clip(7, 45, 160,
                         120); // these coords are set in MissionMessage.cpp
        }
        else {
...
hud_maybe_display_supernova()
{
    ...
    gr_printf(Supernova_coords[gr_screen.res][0],
    ...
    if (timestamp_elapsed(throttle_sound_check_id)) {
        ...
        if (Ships[Player_obj->instance].current_max_speed == 0) {
            percent_throttle =
                ...
                Ship_info[Ships[Player_obj->instance].ship_info_index].max_speed;
        }
        else {
...
hud_damage_popup_init()
{
    ...
    if (!Damage_gauges_loaded) {
        for (i = 0; i < NUM_DAMAGE_GAUGES; i++) {
            Damage_gauges[i].first_frame = bm_load_animation(
                Damage_gauge_fnames[gr_screen.res][i],
                &Damage_gauges[i].num_frames);
...
hud_show_damage_popup()
{
    ...
    GR_AABITMAP(Damage_gauges[0].first_frame,
                Damage_gauge_coords[gr_screen.res][0][0],
                Damage_gauge_coords[gr_screen.res][0][1]);
    gr_string(Damage_text_coords[gr_screen.res][0],
              Damage_text_coords[gr_screen.res][1], XSTR("damage", 218));
    ...
    if (screen_integrity < 100) {
        ...
        gr_string(Hull_integ_coords[gr_screen.res][0],
                  Hull_integ_coords[gr_screen.res][1],
                  XSTR("Hull Integrity", 220));
        gr_string(Hull_integ_val_coords[gr_screen.res][0] - w,
                  Hull_integ_val_coords[gr_screen.res][1], buf);
    }
    ...
    for (pss = GET_FIRST(&Player_ship->subsys_list);
         pss != END_OF_LIST(&Player_ship->subsys_list); pss = GET_NEXT(pss)) {
    ...
    for (int i = 0; i < num; i++) {
        ...
        if (!timestamp_elapsed(
            ...
            if (timestamp_elapsed(Pl_hud_next_flash_timestamp)) {
                Pl_hud_is_bright ^= 1;
                Pl_hud_next_flash_timestamp = timestamp(
                    SUBSYS_DAMAGE_FLASH_INTERVAL);
            }

            if (Pl_hud_is_bright) {
                int alpha_color;
                alpha_color = min(HUD_COLOR_ALPHA_MAX,
                                  HUD_color_alpha + HUD_BRIGHT_DELTA);
        ...
        gr_string(
            sx, sy,
            hud_targetbox_truncate_subsys_name(hud_subsys_list[best_index].name));
...
void
hud_num_make_mono(char *num_str)
{
    int len, i, sc;
    len = strlen(num_str);
...
hud_start_text_flash(char *txt, int t)
{
    ...
    if (!strcmp(Hud_text_flash, NOX("Emp")) &&
        !hud_targetbox_flash_expired(TBOX_FLASH_CMEASURE)) {
        return;
    }
...
hud_maybe_show_text_flash_icon()
{
    ...
    // draw
    hud_show_text_flash_icon(Hud_text_flash,
                             Hud_text_flash_coords[gr_screen.res][1], bright);
}

void
hud_show_text_flash_icon(char *txt, int y, int bright)
{
    int w, h;
    ...
    // draw the box
    gr_rect((int)((((float)gr_screen.max_w / 2.0f) - ((float)w / 2.0f)) - 1.0f),
            (int)((float)y - 1.0f), w + 2, h + 1);
...
hud_show_kills_gauge()
{
    ...
    // draw background
    GR_AABITMAP(Kills_gauge.first_frame, Kills_gauge_coords[gr_screen.res][0],
                Kills_gauge_coords[gr_screen.res][1]);

    gr_string(Kills_text_coords[gr_screen.res][0],
              Kills_text_coords[gr_screen.res][1], XSTR("kills:", 223));
    ...
    gr_string(Kills_text_val_coords[gr_screen.res][0] - w,
              Kills_text_val_coords[gr_screen.res][1], num_kills_string);
}
...
hud_init_kills_gauge()
{
    if (!Kills_gauge_loaded) {
        Kills_gauge.first_frame = bm_load_animation(Kills_fname[gr_screen.res],
                                                    &Kills_gauge.num_frames);
        if (Kills_gauge.first_frame == -1) {
            Warning(
                LOCATION,
                "Could not load in the kills ani: Kills_fname[gr_screen.res]\n");
            return;
        }
...
hud_support_view_init()
{
    ...
    if (!Support_view_gauge_loaded) {
        Support_view_gauge.first_frame = bm_load_animation(
            Support_fname[gr_screen.res], &Support_view_gauge.num_frames);
        if (Support_view_gauge.first_frame == -1) {
            Warning(LOCATION,
                    "Could not load in ani: Support_fname[gr_screen.res]\n");
        }
...
void
hud_support_view_stop(int stop_now)
{
    if (stop_now) {
        Hud_support_view_active = 0;
        Hud_support_view_fade = 1;
...
hud_support_get_dock_time(int objnum)
{
    ...
    vm_vec_sub(&rel_vel, &support_objp->phys_info.vel,
               &other_objp->phys_info.vel);
    ...
    if (rel_speed <=
        support_speed /
            2.0f) { //  This means the player is moving away fast from the support ship.
...
int
hud_support_find_closest(int objnum)
{
    ship_obj *sop;
    ai_info *aip;
    object *objp;
    ...
    while (sop != END_OF_LIST(&Ship_obj_list)) {
        if (Ship_info[Ships[Objects[sop->objnum].instance].ship_info_index].flags &
            SIF_SUPPORT) {
            int pship_index, sindex;

            // make sure support ship is not dying
            if (!(Ships[Objects[sop->objnum].instance].flags &
                  (SF_DYING | SF_EXPLODED))) {
...
hud_support_view_blit()
{
    ...
    GR_AABITMAP(Support_view_gauge.first_frame,
                Support_view_coords[gr_screen.res][0],
                Support_view_coords[gr_screen.res][1]);

    gr_string(Support_text_coords[gr_screen.res][0],
              Support_text_coords[gr_screen.res][1], XSTR("support", 224));

    if (Hud_support_view_fade > 1) {
        if (!timestamp_elapsed(Hud_support_view_fade)) {
            if (Hud_support_view_abort) {
                gr_string(0x8000, Support_text_val_coords[gr_screen.res][1],
                          XSTR("aborted", 225));
            }
            else {
                gr_string(0x8000, Support_text_val_coords[gr_screen.res][1],
    ...
    if (Player_ai->ai_flags & AIF_BEING_REPAIRED) {
        ...
        if ((ship_get_subsystem_strength(Player_ship, SUBSYSTEM_ENGINE) < 1.0) ||
            ...
            (ship_get_subsystem_strength(Player_ship, SUBSYSTEM_COMMUNICATION) <
             1.0)) {
        ...
        if (Hud_support_objnum == -1) {
            ...
            if (!show_time) {
                gr_string(Support_text_dock_coords[gr_screen.res][0],
                          Support_text_val_coords[gr_screen.res][1], outstr);
            }
            else {
                gr_string(Support_text_dock_coords[gr_screen.res][0],
                          Support_text_val_coords[gr_screen.res][1], outstr);
    ...
    if (show_time) {
        ...
        gr_printf(Support_text_dock_val_coords[gr_screen.res][0],
                  Support_text_val_coords[gr_screen.res][1], NOX("%02d:%02d"),
                  minutes, seconds);
    }
}
...
int
hud_gauge_active(int gauge_index)
{
...
int
hud_gauge_is_popup(int gauge_index)
{
    Assert(gauge_index >= 0 && gauge_index < NUM_HUD_GAUGES);
...
int
hud_gauge_popup_active(int gauge_index)
{
    Assert(gauge_index >= 0 && gauge_index < NUM_HUD_GAUGES);
...
void
hud_gauge_popup_start(int gauge_index, int time)
{
    Assert(gauge_index >= 0 && gauge_index < NUM_HUD_GAUGES);
    if (!hud_gauge_is_popup(gauge_index)) {
        return;
...
void
hud_gauge_start_flash(int gauge_index)
{
    Assert(gauge_index >= 0 && gauge_index < NUM_HUD_GAUGES);
...
void
hud_set_gauge_color(int gauge_index, int bright_index)
{
    color use_color;
    ...
    if (bright_index != HUD_C_NONE) {
        ...
        case HUD_C_DIM:
            ...
            gr_init_alphacolor(&use_color, use_color.red, use_color.green,
                               use_color.blue, alpha);
            break;
...
hud_gauge_maybe_flash(int gauge_index)
{
    ...
    if (!timestamp_elapsed(HUD_gauge_flash_duration[gauge_index])) {
        if (timestamp_elapsed(HUD_gauge_flash_next[gauge_index])) {
            HUD_gauge_flash_next[gauge_index] = timestamp(
                HUD_GAUGE_FLASH_INTERVAL);
            HUD_gauge_bright ^=
...
hud_objective_message_init()
{
    ...
    if (!Objective_display_gauge_inited) {
        Objective_display_gauge.first_frame = bm_load_animation(
            Objective_fname[gr_screen.res], &Objective_display_gauge.num_frames);
        if (Objective_display_gauge.first_frame == -1) {
            Warning(LOCATION,
                    "Could not load in ani: Objective_fname[gr_screen.res]\n");
        }
...
hud_add_objective_messsage(int type, int status)
{
    ...
    mission_goal_fetch_num_resolved(type, &Objective_display.goal_nresolved,
...
hud_maybe_display_subspace_notify()
{
    ...
    GR_AABITMAP(Objective_display_gauge.first_frame,
                Objective_display_coords[gr_screen.res][0],
    ...
    gr_string(0x8000, Subspace_text_coords[gr_screen.res][1],
              XSTR("subspace drive", 233));
    if (warp_aborted) {
        gr_string(0x8000, Subspace_text_val_coords[gr_screen.res][1],
                  XSTR("aborted", 225));
    }
    else {
        gr_string(0x8000, Subspace_text_val_coords[gr_screen.res][1],
...
hud_maybe_display_red_alert()
{
    ...
    // blit the background
    gr_set_color_fast(
        &Color_red); // color box red, cuz its an emergency for cryin out loud
    ...
    gr_string(0x8000, Red_text_coords[gr_screen.res][1],
              XSTR("downloading new", 235));
    gr_string(0x8000, Red_text_val_coords[gr_screen.res][1],
              XSTR("orders...", 236));
...
hud_maybe_display_objective_message()
{
    ...
    case PRIMARY_GOAL:
        gr_string(0x8000, Objective_text_coords[gr_screen.res][1],
    ...
    case BONUS_GOAL:
        switch (Objective_display.goal_status) {
        case GOAL_FAILED:
            gr_string(0x8000, Objective_text_val_coords[gr_screen.res][1],
                      XSTR("failed", 242));
            break;
        default:
            gr_string(0x8000, Objective_text_val_coords[gr_screen.res][1],
...
// Gamma wings
int
hud_wing_slot_from_name(char *name)
{
    int rval;
    char num[2];
...
int
hud_wing_index_from_ship(int shipnum)
{
    int i;
    ship *shipp;
...
void
hud_end_string_at_first_hash_symbol(char *src)
{
...
void
HUD_set_offsets(object *viewer_obj, int wiggedy_wack)
{
    if ((viewer_obj == Player_obj) && wiggedy_wack) {
        ...
        vm_vec_scale_add(&tmp, &Viewer_obj->pos, &Viewer_obj->orient.fvec,
                         100.0f);
        ...
        if (flags == 0) {
            ...
            if (!(pt.flags & PF_OVERFLOW)) {
                HUD_offset_x -= 0.45f *
                                (i2fl(gr_screen.clip_width) * 0.5f - pt.sx);
                HUD_offset_y -= 0.45f *
                                (i2fl(gr_screen.clip_height) * 0.5f - pt.sy);
            }
        }
...
void
HUD_set_clip(int x, int y, int w, int h)
{
    int hx = fl2i(HUD_offset_x);
    int hy = fl2i(HUD_offset_y);
...
hud_page_in()
{
    ...
    bm_page_in_aabitmap(Head_frame_gauge.first_frame,
                        Head_frame_gauge.num_frames);
    bm_page_in_aabitmap(Mission_time_gauge.first_frame,
                        Mission_time_gauge.num_frames);
    for (i = 0; i < NUM_DAMAGE_GAUGES; i++) {
        bm_page_in_aabitmap(Damage_gauges[i].first_frame,
                            Damage_gauges[i].num_frames);
    }

    bm_page_in_aabitmap(Support_view_gauge.first_frame,
                        Support_view_gauge.num_frames);
    bm_page_in_aabitmap(Objective_display_gauge.first_frame,
