...
extern int Badge_index
    [MAX_BADGES]; // array which contains indices into Medals to indicate which medals are badges
...
extern int
    Medal_ID; // ID of the medal to display in this screen. Should be set by the caller
