...
void
ui_hline(int x1, int x2, int y)
{
    gr_line(x1, y, x2, y);
}

void
ui_vline(int y1, int y2, int x)
{
    gr_line(x, y1, x, y2);
}
...
void
ui_draw_shad(int x1, int y1, int x2, int y2, color *c1, color *c2)
{
...
void
ui_draw_frame(int x1, int y1, int x2, int y2)
{
...
void
ui_rect(int x1, int y1, int x2, int y2)
{
    gr_rect(x1, y1, x2 - x1 + 1, y2 - y1 + 1);
}

void
ui_draw_box_out(int x1, int y1, int x2, int y2)
{
...
void
ui_draw_box_in(int x1, int y1, int x2, int y2)
{
    gr_set_color_fast(&CWHITE);
    gr_rect(x1 + 2, y1 + 2, (x2 - 2) - (x1 + 2) + 1, (y2 - 2) - (y1 + 2) + 1);
...
void
ui_draw_line_in(int x1, int y1, int x2, int y2)
{
...
void
ui_draw_sunken_border(int x1, int y1, int x2, int y2)
{
    gr_set_color_fast(&CGRAY);
    ui_hline(x1 - 1, x2 + 1, y1 - 1);
