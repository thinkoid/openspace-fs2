...
//
// SHA-256 is hand-rolled (FIPS 180-4) in sha256.hh, shared with vpstage --
// the PCX bargain again; see that header. The manifest-check gate recomputes
// every digest with python's hashlib, so a mistake there cannot survive.
